...
gather(key = "type", value = "Node", -Voltage,-Link) %>%
  ...
  BaseCoords <- BaseCoords %>%
    mutate(Latitude = (Latitude-CoordLims$Latitude_min)/(CoordLims$Latitude_max-CoordLims$Latitude_min),
           Longitude =  (Longitude-CoordLims$Longitude_min)/(CoordLims$Longitude_max-CoordLims$Longitude_min),
